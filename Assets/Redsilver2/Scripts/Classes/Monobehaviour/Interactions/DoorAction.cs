...
namespace RedSilver2.Framework.Interactions.Actions
{
    ...
    public abstract class DoorAction : InteractionAction
    {
        private Door door;
        ...
        protected virtual void SetInteractionEvent(Door door, Interaction interaction, bool isAddingEvent) {
        ...
        protected abstract UnityAction<InteractionHandler> GetOnInteractedAction(Door door);
    }
}
