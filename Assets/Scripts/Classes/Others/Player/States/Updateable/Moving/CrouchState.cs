    ...
    public partial class PlayerStateMachine 
    {
        public sealed class CrouchState : MoveState
        {
            ...
            public static OverrideableHoldInput GetCrouchHoldInput()
            {
                ...
                if (result == null) return new OverrideableHoldInput(CROUCH_HOLD_INPUT_NAME, KeyboardKey.C, GamepadKey.ButtonEast);
                return result;
            }
            ...
            public static OverrideablePressInput GetCrouchPressInput()
            {
                ...
                if (result == null) return new OverrideablePressInput(CROUCH_PRESS_INPUT_NAME, KeyboardKey.C, GamepadKey.ButtonEast);
                return result;
            }
        }
    }
